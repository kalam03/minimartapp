...
const NAV_LABEL_KEY_BY_PATH: Record<string, string> = {
  ...
  '/capital-transaction':       'shared.nav.capitalTransaction',
...
const FALLBACK_NAV: NavItem[] = [
  ...
  { path: '/unit-types',          icon: 'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 7h10v10H7z',                                                                                                                                                                                                                                                                     label: 'Unit Types'  },
  { path: '/categories',          icon: 'M7 7h.01M7 3h5.586a1 1 0 01.707.293l7.414 7.414a1 1 0 010 1.414l-7.586 7.586a1 1 0 01-1.414 0l-7.414-7.414A1 1 0 014 11.586V6a3 3 0 013-3z',                                                                                                                                                                                           label: 'Categories'  },
  { path: '/barcode-generator',   icon: 'M4 6h.01M4 12h.01M4 18h.01M8 6h12M8 12h12M8 18h12',                                                                                                                                                                                                                                                                                     label: 'Barcode Generator' },
  ...
  { path: '/capital-transaction', icon: 'M8 7h12m0 0l-4-4m4 4l-4 4M16 17H4m0 0l4 4m-4-4l4-4', label: 'Capital Transaction' },
  ...
  { path: '/reports',             icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6',                                                                                                                                                                                                                                                                                                       label: 'Reports' },
];
