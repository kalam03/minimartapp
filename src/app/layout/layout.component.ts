...
export class LayoutComponent {
  ...
  navItems = [
    ...
    { path: '/suppliers', icon: 'M20 7L4 7M20 12L4 12M20 17L4 17M8 3v4m8-4v4', label: 'Suppliers', active: false },
    { path: '/products', icon: 'M20 7L4 7M20 12L4 12M20 17L4 17M8 3v4m8-4v4', label: 'Products', active: false },
     { path: '/Purchases', icon: 'M20 7L4 7M20 12L4 12M20 17L4 17M8 3v4m8-4v4', label: 'Purchases', active: false },
