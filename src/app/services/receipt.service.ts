  ...
  buildThermalReceiptHTML(data?: ReceiptData): string {
    ...
    return `
      ...
      <div class="summary-line">
        <span>Tel: ${this.escapeHtml(receiptData.customerMobile)}</span>
        <span>Generated by: ${this.escapeHtml(receiptData.generatedBy)}</span>
      </div>
      ...
      <div class="payment-method">
        <span>Payment: ${this.escapeHtml(receiptData.paymentMethod)}</span>
